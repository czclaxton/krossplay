  ...
  return (
    <div className='hidden h-screen overflow-auto border-r border-midnight p-5 pb-36 text-xs text-whiteA scrollbar-hide sm:max-w-[12rem] md:inline-flex lg:max-w-[15rem] lg:text-sm'>
      <div className='space-y-1'>
        <button className='delay-50 flex items-center space-x-2 py-2 transition duration-300  ease-in-out hover:scale-105 hover:text-pinkA'>
          <HomeIcon className='h-5 w-5' />
          <p>Home</p>
        </button>
        <button className='hover:text-whitetransition flex items-center space-x-2 py-2 duration-300  ease-in-out hover:scale-105 hover:text-pinkA'>
          <SearchIcon className='h-5 w-5' />
          <p>Search</p>
        </button>
        <button className='flex items-center space-x-2 py-2 transition duration-300  ease-in-out hover:scale-105 hover:text-pinkA'>
        ...
        {Object.values(playlistsState.entities).map(playlist => (
          <p
            key={playlist.id}
            className='cursor-pointer py-1 hover:text-pinkA'
            onClick={() =>
              dispatch(
